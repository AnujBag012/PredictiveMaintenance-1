...
const Login = () => {
    ...
    const handleSubmit = (e)=>{
        e.preventDefault()
        axios.post('https://predictivemaintenance-1.onrender.com/Login',{role, email, password})
        .then(result => {
            console.log(result)
      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-500 p-10 lg:p-14 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-wide">A.S</h1>
          </div>
          ...
          <div className="relative z-10 mt-10">
            ...
            <p className="mt-6 text-gray-200 max-w-md text-lg leading-relaxed">
              Secure your industrial workflow with real-time insights and
            ...
            <div className="mt-8 max-w-sm">
              ...
              >
                <option className="text-black">Choose Role</option>
        ...
        <div className="bg-[#f7f8fc] flex items-center justify-center p-8 lg:p-12">
          <div className="w-full max-w-md">
            ...
            <p className="text-gray-500 mb-8">
              Access your smart factory dashboard.
            </p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between text-sm text-gray-500">
                ...
                <span className="hover:text-blue-600 cursor-pointer transition-all duration-300">
                  Forgot password?
                  </span>
              </div>
